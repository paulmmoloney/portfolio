...
![Windows Features - .NET Framework](images/win_feat_net.png){ width="400" }

/// caption
Windows Features - .NET Framework
///

![Windows Features - Web Management Tools](images/win_feat_wmt.png){ width="400" }

/// caption
Windows Features - Web Management Tools
///

![Windows Features - MSMQ](images/win_feat_msmq.png){ width="400" }
