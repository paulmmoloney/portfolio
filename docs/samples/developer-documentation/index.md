...
!!! note
    ...
    As these samples are from documentation that was originally hyperlinked and modular, note that
    not all concepts are explained. This version has been adapted for portfolio purposes from the original publication.
